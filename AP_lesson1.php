...
$sql = "SELECT * FROM araling_panlipunan_lessons WHERE id = $id LIMIT 1";
$result = mysqli_query($conn, $sql);
$lesson = mysqli_fetch_assoc($result);

if (!$lesson) {
    die("Lesson not found. Please ensure you have run the Araling Panlipunan SQL insert.");
}
?>
...
<div class="lesson-item">
    <span>Aralin <?php echo $id; ?>.1</span>
...
onclick="window.location.href='ap_quiz<?php echo $id; ?>.php'">
Start Week <?php echo $id; ?> Quiz
</button>
