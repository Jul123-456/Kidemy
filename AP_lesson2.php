...
if (!$lesson) {
    die("Lesson for Week 2 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="lesson-item">
    <span>Aralin 2.1: Relatibong Lokasyon ng Pilipinas</span>
...
onclick="window.location.href='ap_quiz2.php'">
Start Week 2 Quiz
</button>
