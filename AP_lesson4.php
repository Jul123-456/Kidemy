...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Aralin 4.1: Klima at Panahon sa Pilipinas</span>
    ...
    <button class="btn-action" style="background:#0284c7" onclick="window.location.href='ap_quiz4.php'">
        Start Week 4 Quiz
    </button>
</div>
