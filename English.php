...
<head>
    <meta charset="UTF-8">
    <title>English Modules | Kidemy</title>
    <style>
        ...
        h2 { color: #2c3e50; margin-bottom: 20px; padding-left: 5px; }
        ...
        #movableBtn {
            ...
            font-size: 24px; cursor: grab; box-shadow: 0 4px 10px rgba(0,0,0,0.2);
...
<div class="frame">
    ...
    <a href="Dashboard.php" class="card card-home">
        ...
        <div>
            ...
            <small style="opacity: 0.8;">Return to main menu</small>
        </div>
    </a>
    ...
    $lessons = [
        1 => "Story Analysis",
        2 => "Posters and Visuals",
        3 => "Word Walls & Vocabulary",
        4 => "MATATAG Core Skills",
        5 => "Conjunctions & Grammar",
        6 => "Expressions & Feelings",
        7 => "Visual Text Purpose",
        8 => "Slogans and Messaging"
    ];

    foreach ($lessons as $id => $title) {
        $targetFile = "English_lesson" . $id . ".php";
        echo "
