...
if (!$lesson) {
    die("Lesson for Week 3 not found. Make sure to run the SQL INSERT first.");
}
?>
...
.btn-quiz { background: #3498db; margin-top: 10px; box-shadow: 0 4px 12px rgba(220, 38, 38, 0.2); }
.btn-action:hover { opacity: 0.9; transform: translateY(-2px); }

/* ➕ Minimal video block (matches layout) */
.video-wrapper {
    margin-bottom: 20px;
    border-radius: 15px;
    overflow: hidden;
...
<div class="lesson-item">
    <span>Lesson 3.1: Vocabulary Building</span>
...
onclick="window.location.href='english_quiz3.php'">
Take Week 3 Quiz
</button>
