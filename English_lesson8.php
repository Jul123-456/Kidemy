...
if (!$lesson) {
    die("Lesson for Week 8 not found. Please run the SQL INSERT first.");
}
?>
...
.btn-red { background: #dc2626; color: white; margin-top: 10px; box-shadow: 0 4px 12px rgba(220, 38, 38, 0.2); }
...
<div class="lesson-item">
    <span>Lesson 8.1: Core Skills Review</span>
...
onclick="window.location.href='english_quiz8.php'">
Take Week 8 Quiz
</button>
