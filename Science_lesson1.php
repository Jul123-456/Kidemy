...
$lesson_id = isset($_GET['id']) ? intval($_GET['id']) : 1;

$sql = "SELECT * FROM science_lessons WHERE id = $lesson_id LIMIT 1";
$result = mysqli_query($conn, $sql);
$lesson = mysqli_fetch_assoc($result);

if (!$lesson) {
    die("Lesson not found in the database.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 1.1: Filipino & Global Inventions</span>
    ...
    <button class="btn-action" style="background: #2ecc71; margin-top: 10px;" onclick="window.location.href='science_view1.php'">
        Take Week 1 Quiz
    </button>
</div>
