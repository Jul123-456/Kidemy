...
if (!$lesson) {
    die("Science Lesson for Week 2 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 2.1: Characteristics of Inventors</span>
        <span style="color:#ccc;">⌵</span>
    </div>

    <button class="btn-action btn-pdf" onclick="window.open('<?php echo htmlspecialchars($lesson['pdf_file']); ?>', '_blank')">
        View Module (PDF)
    </button>

    <button class="btn-action btn-quiz" onclick="window.location.href='science_quiz2.php'">
        Take Week 2 Quiz
    </button>
</div>
