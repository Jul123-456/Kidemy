...
if (!$lesson) {
    die("Science Lesson for Week 3 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 3.1: Reactivity and Flammability</span>
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='science_quiz3.php'">
        Take Week 3 Quiz
    </button>
</div>
