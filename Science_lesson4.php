...
if (!$lesson) {
    die("Science Lesson for Week 4 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 4.1: Evidence of Change</span>
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='science_quiz4.php'">
        Take Week 4 Quiz
    </button>
</div>
