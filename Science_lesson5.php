...
if (!$lesson) {
    die("Science Lesson for Week 5 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 5.1: The 5R Principles</span>
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='science_quiz5.php'">
        Take Week 5 Quiz
    </button>
</div>
