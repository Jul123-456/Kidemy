...
if (!$lesson) {
    die("Science Lesson for Week 6 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 6.1: Our Environment & Ecosystems</span>
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='science_quiz6.php'">
        Take Week 6 Quiz
    </button>
</div>
