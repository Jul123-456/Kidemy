...
if (!$lesson) {
    die("Science Lesson for Week 7 not found. Please run the SQL INSERT first.");
}
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 7.1: Natural Resources & Conservation</span>
    ...
    <button class="btn-action" onclick="window.location.href='science_quiz7.php'">
        Take Week 7 Quiz
    </button>
</div>
