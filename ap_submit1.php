...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 1. Calculate Score mula sa ap_quiz1
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM ap_quiz1");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('$student_name', 'Araling Panlipunan 1', $score, $total)";
...
<head>
    ...
    <style>
        ...
        .btn { display: block; text-decoration: none; padding: 16px; border-radius: 12px; font-weight: 600; margin-bottom: 10px; transition: 0.3s; }
...
<div class="result-card">
    ...
    <div class="score-box">
        ...
        <div class="score-label">Puntos na Nakuha</div>
    </div>

    <a href="ap_quiz1.php" class="btn btn-primary">Ulitin ang Quiz</a>
