...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 1. Calculate Score mula sa ap_quiz3
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM ap_quiz3");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('$student_name', 'Araling Panlipunan 3', $score, $total)";
...
<div class="result-card">
    ...
    <div class="score-box">
        ...
        <div class="score-label">Puntos sa Linggo 3</div>
    </div>

    <a href="ap_view3.php" class="btn btn-primary">Ulitin ang Quiz</a>
