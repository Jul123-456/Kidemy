...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 1. Calculate Score mula sa ap_quiz4
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM ap_quiz4");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('$student_name', 'Araling Panlipunan 4', $score, $total)";
...
<div class="result-card">
    <div class="icon"><?php echo ($score >= ($total/2)) ? "🌟" : "⛰️"; ?></div>
    <h1>Na-save ang Score!</h1>
    <p>Magaling, <strong><?php echo htmlspecialchars($student_name); ?></strong>!</p>

    <div class="score-box">
        <div class="score-val"><?php echo $score; ?>/<?php echo $total; ?></div>
        <div class="score-label">Puntos sa Linggo 4</div>
    </div>

    <a href="ap_view4.php" class="btn btn-primary">Ulitin ang Quiz</a>
