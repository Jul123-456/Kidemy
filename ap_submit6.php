...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 1. Calculate Score mula sa ap_quiz6
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM ap_quiz6");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('$student_name', 'Araling Panlipunan 6', $score, $total)";
...
<div class="result-card">
    ...
    <div class="score-box">
        ...
        <div class="score-label">Puntos sa Linggo 6</div>
    </div>

    <a href="ap_view6.php" class="btn btn-primary">Ulitin ang Quiz</a>
