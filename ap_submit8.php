...
// 2. Fetch questions from the Lesson 8 table
...
<head>
    ...
    <style>
        ...
        .submit-btn { width: 100%; background: #22c55e; color: white; border: none; padding: 16px; border-radius: 12px; font-size: 16px; font-weight: 600; cursor: pointer; margin-top: 10px; box-shadow: 0 4px 12px rgba(34, 197, 94, 0.2); }
    </style>
</head>
<body>
