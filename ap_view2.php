...
$result = mysqli_query($conn, "SELECT * FROM ap_quiz2");
?>
...
<div class="mobile-container">
    <div class="header">
        <h1>AP Linggo 2 Quiz</h1>
        <p>Tiyak na Lokasyon ng Pilipinas</p>
    </div>

    <form action="ap_submit2.php" method="POST">
