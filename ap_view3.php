...
// 2. Fetch questions from the Lesson 3 table
$result = mysqli_query($conn, "SELECT * FROM ap_quiz3");
?>
...
<div class="mobile-container">
    <div class="header">
        <h1>AP Linggo 3 Quiz</h1>
        <p>Teritoryo ng Pilipinas (Kasaysayan at Batas)</p>
    </div>

    <form action="ap_submit3.php" method="POST">
