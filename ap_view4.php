...
// 2. Fetch questions from the Lesson 4 table
$result = mysqli_query($conn, "SELECT * FROM ap_quiz4");
?>
...
<div class="mobile-container">
    <div class="header">
        <h1>AP Linggo 4 Quiz</h1>
        <p>Heograpiya at Pagkakakilanlang Pilipino</p>
    </div>

    <form action="ap_submit4.php" method="POST">
