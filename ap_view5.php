...
// 2. Fetch questions from the Lesson 5 table
$result = mysqli_query($conn, "SELECT * FROM ap_quiz5");
?>
...
<div class="mobile-container">
    <div class="header">
        <h1>AP Linggo 5 Quiz</h1>
        <p>Heograpiya at Pag-unlad ng Bansa</p>
    </div>

    <form action="ap_submit5.php" method="POST">
