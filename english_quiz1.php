...
$result = mysqli_query($conn, "SELECT * FROM english_quiz1 LIMIT 10");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Kidemy | English Week 1 Quiz</title>
    <style>
        ...
        .option:hover { background: #fff5f5; }
