...
<head>
    ...
    <style>
        ...
        .submit-btn { width: 100%; background: #0284c7; color: white; border: none; padding: 15px; border-radius: 15px; font-weight: bold; cursor: pointer; font-size: 16px; }
    </style>
</head>
<body>
...
<div class="quiz-card">
    <div class="header">
        ...
        <h2>Lesson 2: What are Colds?</h2> 
    </div>

    <form action="english_quiz2.php" method="POST">
