...
// 2. Query specifically for the Week 3 table
...
<head>
    ...
    <style>
        ...
        .back-link { text-decoration: none; color: #dc2626; font-size: 14px; display: block; margin-bottom: 10px; }
...
<div class="quiz-card">
    <a href="English_lesson3.php" class="back-link">‹ Back to Lesson</a>
    
    <div class="header">
        <small>English 4 - Quarter 1</small>
        <h2>Week 3: Word Structure</h2> 
    </div>
