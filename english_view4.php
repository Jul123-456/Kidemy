...
$result = mysqli_query($conn, "SELECT * FROM english_quiz4");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Kidemy | English Week 4 Quiz</title>
    <style>
        ...
        .submit-btn { width: 100%; background: #3498db; color: white; border: none; padding: 15px; border-radius: 15px; font-weight: bold; cursor: pointer; }
    </style>
</head>
<body>
<div class="quiz-card">
    <div class="header">
        ...
        <h2>Week 4: Grammar & Nouns</h2>
    </div>
    <form action="english_submit4.php" method="POST">
