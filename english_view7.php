...
// 2. Query specifically for the Week 7 table
...
<head>
    ...
    <style>
        /* Consistent Blue Theme matching english_view4.php */
...
<div class="quiz-card">
    <a href="English_lesson7.php" class="back-link">‹ Back to Lesson</a>
    
    <div class="header">
        <small>English 4 - Quarter 1</small>
        <h2>Week 7: Visual Texts & Real vs. Make-believe</h2> 
    </div>
    ...
    <form action="english_submit7.php" method="POST">
        <?php if($result && mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="text-align:center; color:#666;">Waiting for questions... Ensure the english_quiz7 table is ready.</p>
        <?php endif; ?>
