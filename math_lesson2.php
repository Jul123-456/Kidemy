...
if (!$lesson) {
    die("Math Lesson for Week 2 not found. Please run the SQL INSERT first.");
}


$m2_video = "videos/M2.mp4"; 
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 2.1: Introduction</span>
        <span style="color:#ccc;">⌵</span>
    </div>

   
    <div class="section-label">Watch the M2 Video:</div>
    <video controls>
        <source src="<?php echo $m2_video; ?>" type="video/mp4">
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='math_quiz2.php'">
        Start Week 2 Quiz
    </button>
</div>
