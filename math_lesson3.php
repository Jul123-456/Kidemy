...
if (!$lesson) {
    die("Math Lesson for Week 3 not found. Please run the SQL INSERT first.");
}


$m3_video = "videos/M3.mp4"; 
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 3.1: Introduction</span>
        <span style="color:#ccc;">⌵</span>
    </div>

  
    <div class="section-label">Watch the M3 Video:</div>
    <video controls>
        <source src="<?php echo $m3_video; ?>" type="video/mp4">
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='math_quiz3.php'">
        Start Week 3 Quiz
    </button>
</div>
