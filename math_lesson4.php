...
if (!$lesson) {
    die("Math Lesson for Week 4 not found. Please run the SQL INSERT first.");
}


$m4_video = "videos/M4.mp4"; 
?>
...
<div class="mobile-container">
    ...
    <div class="lesson-item">
        <span>Lesson 4.1: Introduction</span>
        <span style="color:#ccc;">⌵</span>
    </div>

    
    <div class="section-label">Watch the M4 Video:</div>
    <video controls>
        <source src="<?php echo $m4_video; ?>" type="video/mp4">
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='math_quiz4.php'">
        Start Week 4 Quiz
    </button>
</div>
