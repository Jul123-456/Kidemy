...
<div class="mobile-container">
    ...
    <div class="section-label">Watch the M5 Video:</div>
    <video controls>
        <source src="<?php echo $m5_video; ?>" type="video/mp4">
    ...
    <button class="btn-action btn-quiz" onclick="window.location.href='math_quiz5.php'">
        Start Week 5 Quiz
    </button>
</div>
