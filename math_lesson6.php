...
// Updated ID to 6 to match Week 6
$id = 6; 
...
$lesson_title = $lesson ? $lesson['title'] : "Rounding Numbers";
$week_label = $lesson ? $lesson['week_label'] : "Week 6";
$description = $lesson ? $lesson['description'] : "In this lesson, you will learn how to round numbers to the nearest hundred thousand, helping you estimate large amounts accurately.";

$m6_video = "videos/M6_rounding.mp4"; 
?>
...
<div class="mobile-container">
    ...
    <div class="badge">Lesson 6: Place Value</div>
    ...
    <div class="lesson-item">
        <div>
            <span style="display:block; font-weight:600;">Lesson 6.1: Rounding Large Numbers</span>
            <small style="color:#888;">Nearest Hundred Thousand</small>
        </div>
    ...
    <video controls>
        <source src="<?php echo $m6_video; ?>" type="video/mp4">
        Your browser does not support the video tag.
    </video>

    <button class="btn-action" onclick="window.open('<?php echo htmlspecialchars($lesson['pdf_file'] ?? 'Q1_LE_Mathematics 4_Lesson 6_Week 6.pdf'); ?>', '_blank')">
        View Math Lesson PDF
    </button>

    <button class="btn-action btn-quiz" onclick="window.location.href='math_quiz6.php'">
        Start Week 6 Math Quiz
    </button>
</div>
