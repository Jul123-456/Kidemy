...
$result = mysqli_query($conn, "SELECT * FROM math_quiz1");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Math Quiz | Week 1</title>
    <style>
        body { font-family: 'Segoe UI', sans-serif; background: #f0f7ff; padding: 20px; display: flex; justify-content: center; }
        .quiz-card { background: white; max-width: 480px; width: 100%; padding: 25px; border-radius: 25px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); }
        ...
        .btn-submit { width: 100%; background: #1e40af; color: white; border: none; padding: 16px; border-radius: 12px; font-weight: bold; cursor: pointer; font-size: 16px; }
    </style>
</head>
<body>
<div class="quiz-card">
    <div class="header">
        <small>Mathematics 4</small>
        <h2>Week 1: Angles Quiz</h2>
    </div>
    <form action="math_submit1.php" method="POST">
