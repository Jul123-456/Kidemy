...
$result = mysqli_query($conn, "SELECT * FROM math_quiz2");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Math Quiz | Week 2</title>
    <style>
...
<div class="quiz-card">
    <div class="header">
        <small>Math 4 - Week 2</small>
        <h2>Triangles & Quadrilaterals</h2>
    </div>
    <form action="math_submit2.php" method="POST">
        ...
        <?php endwhile; ?>
        <button type="submit" class="btn-submit">Submit My Answers</button>
    </form>
</div>
</body>
</html>