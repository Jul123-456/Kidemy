...
$result = mysqli_query($conn, "SELECT * FROM math_quiz3");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Math Quiz | Week 3</title>
    <style>
...
<div class="quiz-card">
    <div class="header">
        <small>Math 4 - Week 3</small>
        <h2>Perimeter Quiz</h2>
    </div>
    <form action="math_submit3.php" method="POST">
