...
$result = mysqli_query($conn, "SELECT * FROM math_quiz5");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Math Quiz | Week 5</title>
    <style>
...
<div class="quiz-card">
    <div class="header">
        <small>Math 4 - Week 5</small>
        <h2>Place Value Quiz</h2>
    </div>
    <form action="math_submit5.php" method="POST">
