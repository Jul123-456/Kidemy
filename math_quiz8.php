...
$result = mysqli_query($conn, "SELECT * FROM math_quiz8 LIMIT 10");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Kidemy | Math Week 8 Quiz</title>
    <style>
...
<div class="quiz-card">
    <div class="header">
        <small>Mathematics 4 - Week 8</small>
        <h2>Estimating Sums and Differences</h2>
    </div>

    <form action="math_submit8.php" method="POST">
        <?php if($result && mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="text-align:center; color:#666;">No questions found. Please check the math_quiz8 table.</p>
        <?php endif; ?>
