...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $score = 0; $total = 0;
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM math_quiz2");
    ...
    // Record score
    $stmt = $conn->prepare("INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) VALUES ('Student', 'Math Week 2', ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Math Results | Week 2</title>
    <style>
...
<body>
    <div class="card">
        <h2>Great Job!</h2>
        <p>You have classified those shapes correctly!</p>
