...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $score = 0; $total = 0;
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM math_quiz3");
    ...
    $stmt = $conn->prepare("INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) VALUES ('Student', 'Math Week 3', ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Math Results | Week 3</title>
    <style>
...
<body>
    <div class="card">
        <h2>Great Calculating!</h2>
        <p>You've mastered the distance around quadrilaterals.</p>
