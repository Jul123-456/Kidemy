...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $score = 0; $total = 0;
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM math_quiz4");
    ...
    // Record results
    $stmt = $conn->prepare("INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) VALUES ('Student', 'Math Week 4', ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Math Results | Week 4</title>
    <style>
...
<body>
    <div class="card">
        <h2>Great Problem Solving!</h2>
        <p>You've mastered finding the perimeter of complex composite shapes.</p>
