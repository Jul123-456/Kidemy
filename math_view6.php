...
// Fetch questions for the quiz interface from the database
...
<head>
    ...
    <style>
        /* Styles based on the uploaded english_view5.php template */
...
<div class="quiz-card">
    ...
    <form action="math_submit6.php" method="POST">
        <?php if($result && mysqli_num_rows($result) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="text-align:center; color:#666;">Waiting for questions... Ensure the math_quiz6 table is ready.</p>
        <?php endif; ?>
