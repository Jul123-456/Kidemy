...
<head>
    <meta charset="UTF-8">
    <title>Math Results | Week 8</title>
    <style>
...
<div class="card">
    ...
    <p><?php 
        ...
        echo ($s >= 7) ? "Great job estimating!" : "Try practicing your rounding skills!"; 
    ?></p>
    <a href="math_quiz8.php" class="btn">Try Again</a>
</div>
