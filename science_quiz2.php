...
$result = mysqli_query($conn, "SELECT * FROM science_quiz2");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Kidemy | Science Week 2 Quiz</title>
    <style>
...
<div class="quiz-card">
    <div class="header">
        ...
        <h2>Week 2: Science Inventions</h2>
    </div>

    <form action="science_submit2.php" method="POST">
        ...
        <?php endwhile; ?>
        <button type="submit" class="submit-btn">Submit Quiz 2</button>
    </form>
</div>
</body>
</html>