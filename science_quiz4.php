...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', sans-serif; background: #fff7ed; padding: 20px; display: flex; justify-content: center; }
        ...
        .header { border-bottom: 2px solid #ffedd5; margin-bottom: 20px; padding-bottom: 10px; }
        .header h2 { color: #ea580c; margin: 0; }
        .q-block { margin-bottom: 20px; padding: 15px; border-radius: 15px; background: #fffaf5; border: 1px solid #fed7aa; }
        ...
        .option:hover { background: #ffedd5; border-color: #fb923c; }
        .submit-btn { width: 100%; background: #ea580c; color: white; border: none; padding: 15px; border-radius: 15px; font-weight: bold; cursor: pointer; font-size: 16px; }
    </style>
</head>
<body>
<div class="quiz-card">
    <div class="header">
        <small>Science 4 - Week 4</small>
        <h2>States & Changes of Matter</h2>
    </div>
    <form action="science_submit4.php" method="POST">
        ...
        <?php endwhile; ?>
        <button type="submit" class="submit-btn">Finish Week 4 Quiz</button>
    </form>
</div>
</body>
</html>