...
$result = mysqli_query($conn, "SELECT * FROM science_quiz6");
?>
...
<head>
    ...
    <title>Kidemy | Science Week 6 Quiz</title>
    <style>
        ...
        .q-block { margin-bottom: 20px; padding: 15px; border-radius: 15px; background: #f9fffb; border: 1px solid #bbf7d0; }
...
<div class="quiz-card">
    <div class="header">
        <small>Science 4 - Week 6</small>
        <h2>Eco-Warrior Quiz</h2>
    </div>

    <form action="science_submit6.php" method="POST">
        ...
        <button type="submit" class="submit-btn">Finish Environmental Quiz</button>
    </form>
</div>
