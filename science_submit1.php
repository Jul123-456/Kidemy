...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $score = 0; $total = 0;
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM science_quiz1");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('Guest Student', 'Science Week 1', $score, $total)";
...
<body>
    <div class="result-card">
        ...
        <p>Your Science results have been saved.</p>
