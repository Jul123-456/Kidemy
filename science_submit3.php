...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $score = 0; $total = 0;
    $result = mysqli_query($conn, "SELECT id, correct_answer FROM science_quiz3");
    ...
    $save_sql = "INSERT INTO student_scores (student_name, quiz_subject, score_achieved, total_questions) 
                 VALUES ('Guest Student', 'Science Week 3', $score, $total)";
...
<body>
    <div class="result-card">
        ...
        <p>Your Science Week 3 results are saved.</p>
        <a href="science_lessons.php" class="btn">Back to Lessons</a>
    </div>
</body>
</html>