...
<div class="result-card">
    ...
    <p class="sub-text">By practicing proper waste disposal and recycling, you help prevent toxic pollution and protect our community!</p>

    <a href="science.php" class="btn-green">Back to Science Lessons</a>
</div>
